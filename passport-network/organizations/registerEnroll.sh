...
function createManufacturer() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:REMOVED_SECRET_ROTATED_2026_04_18@localhost:7054 --caname ca-manufacturer --tls.certfiles "${PWD}/organizations/fabric-ca/manufacturer/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client register --caname ca-manufacturer --id.name manufactureradmin --id.secret manufacturerREMOVED_SECRET_ROTATED_2026_04_18 --id.type admin --tls.certfiles "${PWD}/organizations/fabric-ca/manufacturer/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://manufactureradmin:manufacturerREMOVED_SECRET_ROTATED_2026_04_18@localhost:7054 --caname ca-manufacturer -M "${PWD}/organizations/peerOrganizations/manufacturer.battery.com/users/Admin@manufacturer.battery.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/manufacturer/ca-cert.pem"
  { set +x; } 2>/dev/null
...
function createEVManufacturer() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:REMOVED_SECRET_ROTATED_2026_04_18@localhost:8054 --caname ca-evmanufacturer --tls.certfiles "${PWD}/organizations/fabric-ca/evmanufacturer/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Registering the org admin"
  set -x
  fabric-ca-client register --caname ca-evmanufacturer --id.name evmanufactureradmin --id.secret evmanufacturerREMOVED_SECRET_ROTATED_2026_04_18 --id.type admin --tls.certfiles "${PWD}/organizations/fabric-ca/evmanufacturer/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the org admin msp"
  set -x
  fabric-ca-client enroll -u https://evmanufactureradmin:evmanufacturerREMOVED_SECRET_ROTATED_2026_04_18@localhost:8054 --caname ca-evmanufacturer -M "${PWD}/organizations/peerOrganizations/evmanufacturer.battery.com/users/Admin@evmanufacturer.battery.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/evmanufacturer/ca-cert.pem"
  { set +x; } 2>/dev/null
...
function createService() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:REMOVED_SECRET_ROTATED_2026_04_18@localhost:9054 --caname ca-service --tls.certfiles "${PWD}/organizations/fabric-ca/service/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Registering the org admin"
  set -x
  fabric-ca-client register --caname ca-service --id.name serviceadmin --id.secret serviceREMOVED_SECRET_ROTATED_2026_04_18 --id.type admin --tls.certfiles "${PWD}/organizations/fabric-ca/service/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the org admin msp"
  set -x
  fabric-ca-client enroll -u https://serviceadmin:serviceREMOVED_SECRET_ROTATED_2026_04_18@localhost:9054 --caname ca-service -M "${PWD}/organizations/peerOrganizations/service.battery.com/users/Admin@service.battery.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/service/ca-cert.pem"
  { set +x; } 2>/dev/null
...
function createRegulator() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:REMOVED_SECRET_ROTATED_2026_04_18@localhost:10054 --caname ca-regulator --tls.certfiles "${PWD}/organizations/fabric-ca/regulator/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Registering the org admin"
  set -x
  fabric-ca-client register --caname ca-regulator --id.name regulatoradmin --id.secret regulatorREMOVED_SECRET_ROTATED_2026_04_18 --id.type admin --tls.certfiles "${PWD}/organizations/fabric-ca/regulator/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the org admin msp"
  set -x
  fabric-ca-client enroll -u https://regulatoradmin:regulatorREMOVED_SECRET_ROTATED_2026_04_18@localhost:10054 --caname ca-regulator -M "${PWD}/organizations/peerOrganizations/regulator.battery.com/users/Admin@regulator.battery.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/regulator/ca-cert.pem"
  { set +x; } 2>/dev/null
...
function createOrderer() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:REMOVED_SECRET_ROTATED_2026_04_18@localhost:11054 --caname ca-orderer --tls.certfiles "${PWD}/organizations/fabric-ca/ordererOrg/ca-cert.pem"
  { set +x; } 2>/dev/null
