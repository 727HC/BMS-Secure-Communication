...
#define CSEC_IP_SW_MAJOR_VERSION_C             3
...
*                                         LOCAL VARIABLES
==================================================================================================*/
#define CRYPTO_43_CSEC_START_SEC_VAR_CLEARED_UNSPECIFIED
#include "Crypto_43_CSEC_MemMap.h"

/*! @brief Pointer to CSEc state structure */
static Csec_Ip_StateType* Csec_Ip_pState;

#define CRYPTO_43_CSEC_STOP_SEC_VAR_CLEARED_UNSPECIFIED
#include "Crypto_43_CSEC_MemMap.h"
...
==================================================================================================*/
#define CRYPTO_43_CSEC_START_SEC_RAMCODE
#include "Crypto_43_CSEC_MemMap.h"
...
#define CRYPTO_43_CSEC_STOP_SEC_RAMCODE
#include "Crypto_43_CSEC_MemMap.h"
...
/**
 * @implements     Csec_Ip_WaitCommandCompletion_Activity
 */
static uint32 Csec_Ip_WaitCommandCompletion
(
    uint32 u32Timeout,
...
/**
 * @implements     Csec_Ip_ReadErrorBits_Activity
 */
static Csec_Ip_ErrorCodeType Csec_Ip_ReadErrorBits(void)
{
    uint32                u32ErrWord;
...
)
{
    ...
    SchM_Enter_Crypto_43_CSEC_CRYPTO_EXCLUSIVE_AREA_12();
    ...
    SchM_Exit_Crypto_43_CSEC_CRYPTO_EXCLUSIVE_AREA_12();
}
...
static void Csec_Ip_StartVerifMACCmd(void)
{
    ...
    /* If there is available space in CSE_PRAM, write the MAC to be verified
       According with CSE_PRAM structure latest position which can be used for CMAC is byte number 112*/
...
)
{
    ...
    else
    {
        ...
        /* If the command has run successfully read M1 to M3 */
        if (CSEC_IP_ERC_NO_ERROR == Csec_Ip_pState->ErrCode)
        {
 ...
 */
Csec_Ip_ErrorCodeType Csec_Ip_CancelCommand(void)
{
    ...
    return (Csec_Ip_ErrorCodeType)RetVal;
}
...
)
{
    ...
    else
    {
        ...
        Csec_Ip_WriteCommandWord(CSEC_IP_FLASH_START_ADDRESS_OFFSET_U8, (uint32)&pMsg[0u]);
