...
const Flexcan_Ip_ConfigType FlexCAN_Config0  = {
    ...
    0U),
     /* Can FD RamBlock specified .payload*/
     {
        ...
        (boolean)TRUE,
        /*values for normal baudrate .bitrate - 500kbps @ 24MHz PE clock
         * HW adds +1 to each config value
         * Config: PropSeg=6, PSeg1=4, PSeg2=2, PreDiv=2, RJW=2
         * Actual: PropSeg=7, PSeg1=5, PSeg2=3, PreDiv=3, RJW=3
        ...
        {   /* Prop Seg */
            ...
            /*values for FD baudrate .bitrate - 2Mbps @ 24MHz PE clock
             * Config: FPROPSEG=4, FPSEG1=4, FPSEG2=1, FPRESDIV=0, FRJW=1
             * Actual: PropSeg=4, PSeg1=5, PSeg2=2, PreDiv=1, RJW=2
             * BitTime = 1+4+5+2 = 12 tq
             * 24MHz / (1 * 12) = 2Mbps */
        {   /* Prop Seg */
            (4U),
            /* Phase Seg 1 */
