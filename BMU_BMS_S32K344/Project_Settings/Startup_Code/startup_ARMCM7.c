...
/*----------------------------------------------------------------------------
  Use S32K344 device headers + CMSIS core directly
  (avoids IRQn_Type conflict between generic ARMCM7_SP.h and S32K344_COMMON.h)
 *----------------------------------------------------------------------------*/
#include "S32K344_COMMON.h"       /* IRQn_Type, device base types */
#include "S32K344_MC_RGM.h"       /* MC_RGM register struct */
#include "S32K344_MSCM.h"         /* MSCM (for Sys_GetCoreID) */

/* Defines required by core_cm7.h but missing from S32K344_COMMON.h */
#ifndef __CM7_REV
...
#include "cmsis_compiler.h"       /* __NO_RETURN, __NAKED */
#include "cmsis_gcc.h"            /* __VECTOR_TABLE_ATTRIBUTE, __EARLY_INIT,
                                     __set_MSP, __PROGRAM_START */
#include "system.h"               /* SystemInit declaration */
