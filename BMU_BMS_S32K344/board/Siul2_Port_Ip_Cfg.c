...
*   SW Version           : 6.0.0
*   Build Version        : S32K3_S32M27x_Real-Time_Drivers_AUTOSAR_R21-11_Version_6_0_0_QLP04_HF01_D2510_ASR_REL_4_7_REV_0000_20251010
*
...
const Siul2_Port_Ip_PinSettingsConfig g_pin_mux_InitConfigArr_PortContainer_0_BOARD_InitPeripherals[NUM_OF_CONFIGURED_PINS_PortContainer_0_BOARD_InitPeripherals] =
{
    /* [0] PTA0 - GPIO (original) */
    {
        ...
        .inputMux                    = {
                                         PORT_INPUT_MUX_NO_INIT, PORT_INPUT_MUX_NO_INIT,
                                         PORT_INPUT_MUX_NO_INIT, PORT_INPUT_MUX_NO_INIT,
                                         PORT_INPUT_MUX_NO_INIT, PORT_INPUT_MUX_NO_INIT,
                                         PORT_INPUT_MUX_NO_INIT, PORT_INPUT_MUX_NO_INIT,
                                         PORT_INPUT_MUX_NO_INIT, PORT_INPUT_MUX_NO_INIT,
        ...
        .inputMuxReg                 = {0u,0u,0u,0u,0u,0u,0u,0u,0u,0u,0u,0u,0u,0u,0u,0u},
        .initValue                   = 0u
    },
    /* [1] PTA7 - CAN0_TX (MSCR[7], ALT4, output only) */
    {
        .base                        = IP_SIUL2,
        .pinPortIdx                  = 7u,
        .mux                         = PORT_MUX_ALT4,
    ...
    /* [2] PTA6 - CAN0_RX (MSCR[6], input only, IMCR[0] = ALT2) */
    {
        .base                        = IP_SIUL2,
        .pinPortIdx                  = 6u,
        .mux                         = PORT_MUX_AS_GPIO,
        ...
        .adcInterleaves              = { MUX_MODE_NOT_AVAILABLE, MUX_MODE_NOT_AVAILABLE },
        .inputMux                    = {
                                         PORT_INPUT_MUX_ALT2,    PORT_INPUT_MUX_NO_INIT,
                                         PORT_INPUT_MUX_NO_INIT, PORT_INPUT_MUX_NO_INIT,
                                         PORT_INPUT_MUX_NO_INIT, PORT_INPUT_MUX_NO_INIT,
                                         PORT_INPUT_MUX_NO_INIT, PORT_INPUT_MUX_NO_INIT,
                                         PORT_INPUT_MUX_NO_INIT, PORT_INPUT_MUX_NO_INIT,
    ...
    /* [3] PTC20 (pin 84) - CAN0_STB GPIO output HIGH */
    {
        .base                        = IP_SIUL2,
        .pinPortIdx                  = 84u,
        .mux                         = PORT_MUX_AS_GPIO,
    ...
    /* [4] PTC21 (pin 85) - CAN0_EN GPIO output HIGH */
    {
        .base                        = IP_SIUL2,
        .pinPortIdx                  = 85u,
        .mux                         = PORT_MUX_AS_GPIO,
