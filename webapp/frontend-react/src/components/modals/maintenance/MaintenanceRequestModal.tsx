...
interface Props {
  open: boolean;
  submitting: boolean;
  form: MaintenanceRequestFormData;
  onChange: (form: MaintenanceRequestFormData) => void;
  onClose: () => void;
  onSubmit: () => void;
}

export default function MaintenanceRequestModal({ open, submitting, form, onChange, onClose, onSubmit }: Props) {
  return (
    <BaseModal open={open} onClose={onClose} title="Service task 접수">
