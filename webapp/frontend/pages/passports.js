    ...
    <div class="space-y-6">
      ...
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <button v-if="isManufacturer" @click="openCreateModal"
          class="inline-flex items-center gap-2 px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white font-semibold text-sm rounded-lg transition-colors shadow-sm">
        ...
        <div class="flex flex-col sm:flex-row gap-3">
          <div class="relative flex-1">
            ...
            <input v-model="searchQuery" type="text" placeholder="여권ID, 시리얼번호, 모델, 제조사, VIN 검색..."
              class="w-full pl-9 pr-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 outline-none text-sm" />
          </div>
          <div class="relative">
            <select v-model="filterStatus"
              class="pl-3 pr-8 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 outline-none text-sm appearance-none cursor-pointer min-w-[130px]">
      ...
      <div v-else class="bg-white rounded-lg border border-gray-200 py-16 px-8 text-center">
        ...
        <button v-if="isManufacturer" @click="openCreateModal"
          class="inline-flex items-center gap-2 px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white font-medium text-sm rounded-lg transition-colors">
          <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
            <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4"/>
          </svg>
          첫 여권 발급하기
              ...
              <form @submit.prevent="submitCreate" class="p-6 space-y-6">
                  ...
                  <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input v-model="form.did" type="text" placeholder="did:example:..."
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 outline-none text-sm" />
                    </div>
                    <div>
                  ...
                  <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <select v-model="form.cellType"
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 outline-none text-sm bg-white appearance-none cursor-pointer">
                ...
                <div>
                  <div class="flex items-center gap-2 mb-3">
                    ...
                    <h3 class="text-sm font-bold text-gray-800 uppercase tracking-wider">기술사양</h3>
                  </div>
                    ...
                    <div>
                      ...
                      <div class="flex items-center gap-2">
                        <input v-model="form.voltageRange" type="text" placeholder="300~400"
                          class="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 outline-none text-sm" />
                ...
                <div class="flex justify-end gap-3 pt-4 border-t border-gray-200">
                  ...
                  <button type="submit" :disabled="creating"
                    :class="['px-5 py-2 text-sm font-semibold text-white rounded-lg transition-all',
                      creating ? 'bg-primary-400 cursor-not-allowed' : 'bg-primary-600 hover:bg-primary-700 shadow-sm']">
