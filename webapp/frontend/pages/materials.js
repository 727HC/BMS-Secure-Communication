  ...
  <div style="display:flex;flex-direction:column;gap:24px;">
    ...
    <div class="" style="display:flex;align-items:center;justify-content:space-between;">
      <div style="display:flex;align-items:center;gap:14px;">
        ...
        <div>
          <h1 class="text-[#fafaf5] font-bold" style="font-family:'Pretendard Variable', sans-serif;font-size:1.35rem;color:#111827;margin:0;">원자재 관리</h1>
    ...
    <!-- ====== SEARCH BAR ====== -->
    <div class="bg-[#1a1814]  border border-[rgba(250,250,245,0.06)] shadow-none  " style="padding:12px 16px;">
      <div style="position:relative;">
        ...
        <input v-model="searchQuery" type="text" placeholder="자재ID, 명칭, 원산지, 공급업체, 인증번호 검색..."
          class="w-full px-4 py-2.5 bg-[#1f1d17] border border-[rgba(250,250,245,0.06)]  text-[#fafaf5] outline-none focus:border-[#c8ff00]" style="width:100%;padding-left:38px;font-family:'Pretendard Variable', sans-serif;font-size:0.85rem;" />
      </div>
    </div>
    ...
    <!-- ====== EMPTY STATE ====== -->
    <div v-else-if="filteredMaterials.length === 0" class="bg-[#1a1814]  border border-[rgba(250,250,245,0.06)] shadow-none  " style="display:flex;flex-direction:column;align-items:center;justify-content:center;padding:64px 24px;">
        ...
        <table class="w-full text-sm" style="font-size: 0.8rem;" style="width:100%;">
          ...
          <tbody>
            <tr v-for="(m, idx) in filteredMaterials" :key="m.materialId"
              ...
              <td>
                <span v-if="m.certificationId" class="bg-[rgba(200,255,0,0.08)] text-[#c8ff00]" style="font-family:'JetBrains Mono', monospace;font-size:0.7rem;display:inline-flex;align-items:center;gap:4px;padding:2px 8px;border-radius:6px;">
    ...
    <div v-if="showModal" style="position:fixed;inset:0;z-index:50;display:flex;align-items:center;justify-content:center;padding:16px;">
      ...
      <div class="bg-[#1a1814]  border border-[rgba(250,250,245,0.06)] shadow-none bg-[#1a1814]  border border-[rgba(250,250,245,0.06)] shadow-none " style="position:relative;z-index:1;max-width:520px;width:100%;overflow:hidden;">
        <!-- Modal Header -->
        ...
        <div style="padding:20px 24px;display:flex;flex-direction:column;gap:16px;">
          <div>
            ...
            <input v-model="form.materialId" type="text" readonly class="w-full px-4 py-2.5 bg-[#1f1d17] border border-[rgba(250,250,245,0.06)]  text-[#fafaf5] outline-none focus:border-[#c8ff00]" style="width:100%;font-family:'JetBrains Mono', monospace;color:#6b7280;background:#ffffff;" />
          </div>
          <div>
            ...
            <input v-model="form.name" type="text" placeholder="예: 리튬, 코발트, 니켈" class="w-full px-4 py-2.5 bg-[#1f1d17] border border-[rgba(250,250,245,0.06)]  text-[#fafaf5] outline-none focus:border-[#c8ff00]" style="width:100%;" />
          </div>
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;">
            <div>
              ...
              <input v-model="form.origin" type="text" placeholder="예: 호주" class="w-full px-4 py-2.5 bg-[#1f1d17] border border-[rgba(250,250,245,0.06)]  text-[#fafaf5] outline-none focus:border-[#c8ff00]" style="width:100%;" />
            </div>
            <div>
              ...
              <input v-model="form.supplier" type="text" placeholder="예: ABC Mining" class="w-full px-4 py-2.5 bg-[#1f1d17] border border-[rgba(250,250,245,0.06)]  text-[#fafaf5] outline-none focus:border-[#c8ff00]" style="width:100%;" />
            </div>
          </div>
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;">
            <div>
              ...
              <input v-model="form.quantity" type="number" min="0" step="0.01" placeholder="0" class="w-full px-4 py-2.5 bg-[#1f1d17] border border-[rgba(250,250,245,0.06)]  text-[#fafaf5] outline-none focus:border-[#c8ff00]" style="width:100%;font-variant-numeric:tabular-nums;" />
            </div>
            <div>
              ...
              <select v-model="form.unit" class="w-full px-4 py-2.5 bg-[#1f1d17] border border-[rgba(250,250,245,0.06)]  text-[#fafaf5] outline-none focus:border-[#c8ff00]" style="width:100%;background:#ffffff;">
          ...
          <div>
            ...
            <input v-model="form.certificationId" type="text" placeholder="인증서 번호" class="w-full px-4 py-2.5 bg-[#1f1d17] border border-[rgba(250,250,245,0.06)]  text-[#fafaf5] outline-none focus:border-[#c8ff00]" style="width:100%;" />
          </div>
        </div>
        <!-- Modal Footer -->
      ...
      <div class="bg-[#1a1814]  border border-[rgba(250,250,245,0.06)] shadow-none bg-[#1a1814]  border border-[rgba(250,250,245,0.06)] shadow-none " style="position:relative;z-index:1;max-width:520px;width:100%;overflow:hidden;">
        ...
        <div style="padding:20px 24px;display:flex;flex-direction:column;gap:18px;">
          ...
          <div>
            ...
            <dd class="bg-[rgba(200,255,0,0.08)] text-[#c8ff00]" style="display:inline-flex;font-size:0.72rem;font-weight:600;padding:3px 10px;border-radius:6px;margin:0;">
