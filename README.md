...
- **git history 정리**: 과거 history에 잔존하던 시크릿 4종(`LEGACY_DEFAULT_SECRET`, `LEGACY_PLACEHOLDER_SECRET`, DID seed, wallet key)을 `git filter-repo`로 전 이력에서 제거 완료 (2026-04-18).
